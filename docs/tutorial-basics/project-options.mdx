...
![img_6.png](img_6.png)
### Name & Package Name
The name and package names are unique identifiers of your projects. They are unchangeable after the project creation.
### Description

The description of your extension shown when clicking the info icon of your extension in AI2/ any of its distributions.


### Version Name

The extension's version name is a text representation of the version. For example: 1.0, 2.5.4, 0.3.6-beta, etc..
...
### Proguard Extension
Protects your extension code by obfuscating and optimizing the generated code to be more secure. This is only effective when creating a [release build](build-your-project.md).
